 ...
 */
export declare function createStepConstraint(params: NumberInputParams): Constraint<number> | null;
/**
 * Tries to create a range constraint.
 * @param params The input parameters object.
 * @return A constraint or null if not found.
 */
export declare function createRangeConstraint(params: NumberInputParams): Constraint<number> | null;
/**
 * @hidden
 */
