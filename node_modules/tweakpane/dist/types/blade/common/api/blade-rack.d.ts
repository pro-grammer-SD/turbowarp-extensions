...
import { ButtonParams, FolderParams, InputParams, MonitorParams, SeparatorParams, TabParams } from './params';
...
export declare function addButtonAsBlade(api: BladeRackApi, params: ButtonParams): ButtonApi;
export declare function addFolderAsBlade(api: BladeRackApi, params: FolderParams): FolderApi;
export declare function addSeparatorAsBlade(api: BladeRackApi, opt_params?: SeparatorParams): SeparatorApi;
export declare function addTabAsBlade(api: BladeRackApi, params: TabParams): TabApi;
